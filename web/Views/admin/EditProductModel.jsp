<%-- 
    Document   : EditProductModel
    Created on : Mar 14, 2024, 7:30:43 PM
    Author     : Admin
--%>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editBookForm" action="edit" method="POST" enctype="multipart/form-data">
                    <!--id-->
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <select class="custom-select" id="categoryEditInput" name="category">
                                <c:forEach items="${list_pro}" var="c">
